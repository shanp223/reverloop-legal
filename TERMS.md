...
The [Privacy Policy](PRIVACY.md) describes local storage, optional permissions, notifications, support messages, and website hosting. This version has no user accounts or app-operated cloud backup. Uninstalling the app or losing your device may remove progress, and the developer may be unable to restore it.
